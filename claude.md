...
> **[2026-06-11 운영자 지시] §LOCK 해제됨.** 아래 표는 과거 기준 기록용. 현재 밸런스 기준은
> `run/config/jjk/{config,techniques,domains}.json` + `FABLE_NOTES.md`의 "밸런스 패스 2026-06-11" 섹션이다.
> 단, 임의 변경은 여전히 금지 — 밸런스 변경은 운영자 지시 또는 밸런스 근거를 명시하고 진행할 것.
